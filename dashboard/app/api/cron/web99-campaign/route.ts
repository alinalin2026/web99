...
const KEY = "w99-create-campaign-20260808";
...
export async function GET(req: NextRequest) {
  ...
  if (req.nextUrl.searchParams.get("confirm") !== "CREATE_PAUSED") {
    return NextResponse.json({
      ...
      ads: 5,
      status: "PAUSED",
      targeting: "Republic of Ireland, age 25-65, broad",
      optimization: "Sales objective / Lead conversion",
    });
  }
